 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".about__slider-body")) new core(".about__slider-body", {
        ...
        function headerScroll() {
            ...
            let timer;
            document.addEventListener("windowScroll", onWindowScroll);
...
***************************************************************************** */
        ...
        if (menuLinks.length) menuLinks.forEach((link => {
